...
function Register() {
    ...
    const response = await  fetch('http://localhost:6000/api/users/create-user', {
        method:'POST',
        headers:{
  ...
  <div class="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
    ...
    <div class="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
      <form onSubmit = {RegisterUser()} class="px-5 py-7">
        ...
        <input type="text" onChange={(e) => setPassword(e.target.value)} class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" />
