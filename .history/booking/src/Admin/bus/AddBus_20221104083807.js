...
function Addbus() {
  ...
  return (
    ...
    <div>
			<label for="N" class="block mb-1 ml-1">Name</label>
			<input id="N" type="N" placeholder="Your N" required="" class="block w-full p-2 rounded focus:outline-none focus:ring focus:ring-opacity-25 focus:ring-violet-900 dark:bg-gray-800"/>
		</div>
		<div>
