  ...
  return (
    <>
        <button
          ...
          className="inline-block px-6 py-2.5 bg-[#31087B] text-[#31087B] font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-[#31087B] hover:shadow-lg focus:bg-[#31087B] focus:shadow-lg focus:outline-none focus:ring-0 active:bg-[#31087B] active:shadow-lg transition duration-150 ease-in-out w-15 h-10 "
        >
         New Trip
        </button>
  {/* <div>
