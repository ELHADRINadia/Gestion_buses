...
const createbas = asyncHandler(async (req, res) => {
    const {nombre_bas, Name,date_arriver, date_depart,ville_arriver, places} = req.body;
    if(!nombre_bas || !Name || !places ||date_arriver||date_depart||ville_arriver||ville_depart|| places < 0 || places > 38) {
...
const updatebas = asyncHandler(async (req, res) => {
    const {nombre_bas, Name,date_arriver, date_depart, places} = req.body;
